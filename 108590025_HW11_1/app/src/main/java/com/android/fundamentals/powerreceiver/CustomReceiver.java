...
public class CustomReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String strnum =  intent.getStringExtra(ACTION_CUSTOM_BROADCAST);
        ...
        if (intentAction != null) {
            ...
            Toast.makeText(context, toastMessage + " Square of the number is " + num*num, Toast.LENGTH_SHORT).show();
        }
