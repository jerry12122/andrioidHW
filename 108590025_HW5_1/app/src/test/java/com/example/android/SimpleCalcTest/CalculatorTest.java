...
public class CalculatorTest {
    ...
    public void powPositive() {
        double resultPow = mCalculator.pow(2d, 6d);
        assertThat(resultPow, is(equalTo(64d)));
    }
    @Test
    public void powFirstNagitive() {
        double resultPow = mCalculator.pow(-2d, 6d);
        assertThat(resultPow, is(equalTo(64d)));
    }
    @Test
    public void powSecondNagitive() {
